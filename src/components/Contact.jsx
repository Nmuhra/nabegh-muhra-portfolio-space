          ...
          <div className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-gray-800/70 border border-gray-700 rounded-lg focus:outline-none focus:border-blue-500 text-white"
              />
            </div>
            ...
            <button
              ...
              className="w-full py-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white rounded-lg transition-colors duration-300"
            >
              Send Message
            </button>
          </div>
          ...
          <div className="mt-16 text-center">
            ...
            <div className="flex justify-center space-x-6">
              ...
              {portfolioData.contact.github && (
                <a href={portfolioData.contact.github} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-400 transition-colors">
